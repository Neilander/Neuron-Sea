    ...
    public class SingleShaderGUI : ShaderGUI
    {
        ...
        public static void DisplayProperties(ShaderInformation info, MaterialEditor materialEditor, MaterialProperty[] properties, int startIndex){
            ...
            for (int n = 0; n < properties.Length; n++) {
                ...
                //Hidden:
                if (prop.name == "_texcoord" || prop.name == "_AlphaTex" || prop.name == "_AlphaCutoff" || prop.name == "_UseUIAlphaClip" || prop.name == "_ColorMask" ||
                    prop.name.StartsWith("_Stencil")) {
                    continue;
                }
                ...
                if (prefixSplit.Length > 1) {
                    ...
                    if (prop.name != "_MainTex" && prop.name != "_IsText" && prop.name != "PixelSnap" && prop.name != "_UberNoiseTexture" && prop.name != "_Color" && prop.name != "_NormalMap" &&
                        prop.name != "_MaskMap" && prop.name != "_NormalIntensity" && prop.name != "Uber Mask" && prop.name != "_Brightness" && prop.name != "_FullFade" &&
                        prop.name != "_UberFading" && prop.name != "_Metallic" && prop.name != "_Smoothness" && prop.name != "_HasEmission" && prop.name != "_EmissionMap" &&
                        prop.name != "_EmissionColor" && prop.name != "_SmoothnessMap" && prop.name != "_Contrast" && prop.name != "_Hue" && prop.name != "_UberMask" && prop.name != "_UberSpace" &&
                        prop.name != "_UberPosition" && prop.name != "_UberNoiseScale" && prop.name != "_UberNoiseFactor" && prop.name != "_UberWidth" && prop.name != "_Saturation" &&
                        prop.name != "_ShaderSpace" && prop.name != "_PixelsPerUnit" && prop.name != "_ScreenWidthUnits" && prop.name != "_RectWidth" && prop.name != "_RectHeight" &&
                        prop.name != "_TimeSettings" && prop.name != "_TimeScale" && prop.name != "_TimeFrequency" && prop.name != "_TimeValue" && prop.name != "_TimeRange" &&
                        prop.name != "_TimeFPS") {
                ...
                if (propType != ShaderUtil.ShaderPropertyType.TexEnv && trueName.EndsWith("Toggle") == false && trueName != "Shader Space" && trueName != "Has Emission" && trueName != "Uber Fading" &&
                    trueName != "Time Settings" && prop.name != "_WindIsParallax") {
