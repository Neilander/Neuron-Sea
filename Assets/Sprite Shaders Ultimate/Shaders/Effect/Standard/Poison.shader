    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
				...
				float2 staticSwitch1_g371 = ( texCoord2_g371 / ( _PixelsPerUnit * (_MainTex_TexelSize).xy ) );
                #endif
                float saferPower19_g376 = max(
                    abs((((tex2D(_PoisonNoiseTexture, (((temp_output_41_0_g376 * _PoisonNoiseSpeed) + staticSwitch1_g371) * _PoisonNoiseScale)).r + (temp_output_41_0_g376 * _PoisonShiftSpeed)) % 1.0)
                        + -0.5)), 0.0001);
                ...
                float4 appendResult27_g376 = (float4(((max(pow(saferPower19_g376, _PoisonDensity), 0.0) * temp_output_24_0_g376 * _PoisonFade * _PoisonNoiseBrightness) + lerpResult32_g376),
                                                     temp_output_1_0_g376.a));
