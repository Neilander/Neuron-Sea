    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
				...
				float staticSwitch1_g411 = _Time.y;
                #endif
                float3 hsvTorgb3_g408 = HSVToRGB(float3(
                    (((distance(temp_output_42_0_g406, _RainbowCenter) + (tex2D(_RainbowNoiseTexture, (temp_output_42_0_g406 * _RainbowNoiseScale)).r * _RainbowNoiseFactor)) * _RainbowDensity) + (
                        _RainbowSpeed * staticSwitch1_g411)), 1.0, 1.0));
                ...
                float4 appendResult29_g406 = (float4(
                    ((hsvTorgb37_g406 * pow(saferPower24_g406, max(_RainbowContrast, 0.001)) * (_RainbowFade * (tex2DNode3_g409.r * tex2DNode3_g409.a))) + (temp_output_1_0_g406).rgb),
                    temp_output_1_0_g406.a));
