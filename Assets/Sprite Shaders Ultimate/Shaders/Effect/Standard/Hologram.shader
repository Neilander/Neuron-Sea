    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float2 appendResult44_g423 = (float2(
                    (((clampResult75_g423 * (tex2D(_HologramNoiseTexture, (temp_cast_2 * temp_cast_3)).r - 0.25)) * _HologramDistortionOffset * (100.0 / appendResult2_g424).x) * _HologramFade), 0.0));
                ...
                float4 appendResult22_g427 = (float4(((_HologramTint).rgb * pow(saferPower7_g429, temp_output_9_0_g429)),
                                                     (max(pow(abs(sin(((((temp_output_167_0 * _HologramLineSpeed) + ase_worldPos.y) / unity_OrthoParams.y) * _HologramLineFrequency))),
                                                              _HologramLineGap), _HologramMinAlpha) * temp_output_1_0_g427.a)));
