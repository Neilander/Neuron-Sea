    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float4 lerpResult45_g371 = lerp(temp_output_1_0_g371,
                                                ((max(((_MetalHighlightDensity - tex2D(
                                                              _MetalNoiseTexture,
                                                              ((((tex2D(_MetalNoiseTexture,
                                                                        (((temp_output_59_0_g371 * _MetalNoiseDistortionSpeed) + temp_output_58_0_g371) * _MetalNoiseDistortionScale)).r
                                                                  - 0.25) * _MetalNoiseDistortion) + ((temp_output_59_0_g371 * _MetalNoiseSpeed) + temp_output_58_0_g371)) * _MetalNoiseScale)).r) /
                                                          max(_MetalHighlightDensity, 0.01)),
                                                      0.0) * _MetalHighlightColor * pow(saferPower7_g375, temp_output_9_0_g375)) + (pow(saferPower2_g371, _MetalContrast) * _MetalColor)),
                                                (_MetalFade * (tex2DNode3_g376.r * tex2DNode3_g376.a)));
