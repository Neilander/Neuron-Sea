    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float4 temp_output_1_0_g470 = tex2D(
                    _MainTex,
                    (texCoord135 + ((tex2D(_GlitchDistortionTexture, ((temp_output_154_0 + (_GlitchDistortionSpeed * temp_output_157_0)) * _GlitchDistortionScale)).r - 0.5) * _GlitchDistortion *
                        temp_output_154_15)));
                float4 break2_g472 = temp_output_1_0_g470;
                float temp_output_34_0_g470 = temp_output_157_0;
                float3 hsvTorgb3_g473 = HSVToRGB(float3(
                    (tex2D(_GlitchNoiseTexture, ((temp_output_154_0 + (_GlitchNoiseSpeed * temp_output_34_0_g470)) * _GlitchNoiseScale)).r + (temp_output_34_0_g470 * _GlitchHueSpeed)), 1.0, 1.0));
