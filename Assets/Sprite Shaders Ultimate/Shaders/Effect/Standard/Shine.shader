    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
				...
				float2 staticSwitch1_g376 = ( texCoord2_g376 / ( _PixelsPerUnit * (_MainTex_TexelSize).xy ) );
                #endif
                float3 rotatedValue69_g74 = RotateAroundAxis(float3(0, 0, 0), float3(((staticSwitch1_g387 * _ShineSpeed) + (_ShineScale * staticSwitch1_g376)), 0.0), float3(0, 0, 1),
                                                             ((_ShineRotation / 360.0) * UNITY_PI));
                ...
                float4 appendResult8_g74 = (float4(
                    (temp_output_57_0_g74 + ((pow(saferPower83_g74, temp_cast_2) * (_ShineColor).rgb) * clampResult80_g74 * (_ShineFade * (tex2DNode3_g76.r * tex2DNode3_g76.a)))),
                    (temp_output_1_0_g74).a));
