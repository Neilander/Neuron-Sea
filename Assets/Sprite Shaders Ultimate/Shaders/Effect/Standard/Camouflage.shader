    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
				...
				float staticSwitch1_g435 = _Time.y;
                #endif
                float clampResult52_g310 = clamp(((_CamouflageDensityA - tex2D(_CamouflageNoiseTexture,
                                                                            (((_CamouflageAnimated)
        ? ((((tex2D(_CamouflageNoiseTexture, (((staticSwitch1_g435 * _CamouflageAnimationSpeed) + temp_output_99_0_g310) * _CamouflageDistortionScale)).r - 0.25) *
            _CamouflageDistortionIntensity) + temp_output_99_0_g310))
        : (temp_output_99_0_g310)) * _CamouflageNoiseScaleA)).r) / max(_CamouflageSmoothnessA, 0.005)), 0.0, 1.0);
                float4 lerpResult55_g310 = lerp(_CamouflageBaseColor, (_CamouflageColorA * clampResult52_g310), clampResult52_g310);
                float clampResult65_g310 = clamp(((_CamouflageDensityB - tex2D(_CamouflageNoiseTexture,
                                                                               ((((_CamouflageAnimated)
                                                                                      ? ((((tex2D(_CamouflageNoiseTexture,
                                                                                                  (((staticSwitch1_g435 * _CamouflageAnimationSpeed) + temp_output_99_0_g310) *
                                                                                                      _CamouflageDistortionScale)).r - 0.25) * _CamouflageDistortionIntensity) + temp_output_99_0_g310))
                                                                                      : (temp_output_99_0_g310)) + float2(12.3, 12.3)) * _CamouflageNoiseScaleB)).r) / max(
                ...
                float3 lerpResult4_g310 = lerp((temp_output_1_0_g310).rgb, ((lerpResult68_g310).rgb * pow(saferPower7_g312, temp_output_9_0_g312)),
                                               (_CamouflageFade * (tex2DNode3_g314.r * tex2DNode3_g314.a)));
