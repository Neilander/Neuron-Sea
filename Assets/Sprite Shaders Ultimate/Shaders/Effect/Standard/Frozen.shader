    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float3 lerpResult57_g430 = lerp((temp_output_1_0_g430).rgb,
                                                ((pow(saferPower7_g435, temp_output_9_0_g435) * (_FrozenTint).rgb) + (pow(saferPower20_g430, _FrozenSnowContrast) * ((_FrozenSnowColor).rgb *
                                                    max((_FrozenSnowDensity - tex2D(_FrozenNoiseTexture, (temp_output_72_0_g430 * _FrozenSnowScale)).r), 0.0))) + ((max(
                                                    ((_FrozenHighlightDensity - tex2D(_FrozenNoiseTexture,
                                                                                      ((((tex2D(_FrozenNoiseTexture,
                                                                                                (((temp_output_73_0_g430 * _FrozenHighlightDistortionSpeed) + temp_output_72_0_g430) *
                                                                                                    _FrozenHighlightDistortionScale)).r - 0.25) * _FrozenHighlightDistortion) + ((temp_output_73_0_g430
                                                                                          * _FrozenHighlightSpeed) + temp_output_72_0_g430)) * _FrozenHighlightScale)).r) /
                                                        max(_FrozenHighlightDensity, 0.01)), 0.0) * _FrozenHighlightColor * pow(saferPower42_g430, _FrozenHighlightContrast))).rgb), _FrozenFade);
