        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float clampResult28_g3907 = clamp(
                    (((tex2D(_UberNoiseTexture, (((IN.color.r * ((_SmokeVertexSeed) ? (5.0) : (0.0))) + temp_output_43_0_g3907) * temp_cast_11)).r - 1.0) * _SmokeNoiseFactor) + (((IN.color.a / 2.5) -
                        distance(temp_output_43_0_g3907, float2(0.5, 0.5))) * 2.5 * _SmokeSmoothness)), 0.0, 1.0);
                #ifdef _ENABLESMOKE_ON
                ...
                float clampResult68_g3978 = clamp((_BurnInsideNoiseFactor - tex2D(
                        _UberNoiseTexture,
                        ((((tex2D(_UberNoiseTexture, (temp_output_72_0_g3978 * _BurnSwirlNoiseScale)).r - 0.5) * float2(1, 1) * _BurnSwirlFactor) + temp_output_72_0_g3978) * _BurnInsideNoiseScale)).
                    r), 0.0, 1.0);
                #ifdef _ENABLEBURN_ON
