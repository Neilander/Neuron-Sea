    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata_t IN)
            {
                ...
                float clampResult14_g4042 = clamp(
                    (((_FullFade * (1.0 + temp_output_4_0_g4042)) - tex2Dlod(_UberNoiseTexture, float4((shaderPosition235 * _UberNoiseScale), 0, 0.0)).r) / temp_output_4_0_g4042), 0.0, 1.0);
                float2 temp_output_27_0_g4044 = shaderPosition235;
                float clampResult3_g4044 = clamp(
                    ((_FullFade - (distance(_UberPosition, temp_output_27_0_g4044) + (tex2Dlod(_UberNoiseTexture, float4((temp_output_27_0_g4044 * _UberNoiseScale), 0, 0.0)).r * _UberNoiseFactor))) /
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float3 rotatedValue168_g4025 = RotateAroundAxis(float3(0, 0, 0), float3(_DirectionalDistortionDistortion, 0.0), float3(0, 0, 1),
                     (((tex2D(_UberNoiseTexture, (temp_output_182_0_g4025 * _DirectionalDistortionDistortionScale)).r - 0.5) * 2.0 * _DirectionalDistortionRandomDirection) * UNITY_PI));
                float3 rotatedValue136_g4025 = RotateAroundAxis(float3(0, 0, 0), float3(temp_output_182_0_g4025, 0.0), float3(0, 0, 1),
    (((_DirectionalDistortionRotation / 360.0) + -0.25) * UNITY_PI));
                float3 break130_g4025 = rotatedValue136_g4025;
                float clampResult154_g4025 = clamp(
                    ((break130_g4025.x + break130_g4025.y + _DirectionalDistortionFade + (tex2D(_UberNoiseTexture, (temp_output_182_0_g4025 * _DirectionalDistortionNoiseScale)).r *
                ...
                float temp_output_4_0_g4042 = max(_UberWidth, 0.001);
                float clampResult14_g4042 = clamp((((_FullFade * (1.0 + temp_output_4_0_g4042)) - tex2D(_UberNoiseTexture, (shaderPosition235 * _UberNoiseScale)).r) / temp_output_4_0_g4042), 0.0,
                                                               1.0);
                float2 temp_output_27_0_g4044 = shaderPosition235;
                float clampResult3_g4044 = clamp(
                    ((_FullFade - (distance(_UberPosition, temp_output_27_0_g4044) + (tex2D(_UberNoiseTexture, (temp_output_27_0_g4044 * _UberNoiseScale)).r * _UberNoiseFactor))) /
                        max(_UberWidth, 0.001)), 0.0, 1.0);
                #if defined(_UBERFADING_NONE)
                float staticSwitch139 = _FullFade;
                #elif defined(_UBERFADING_FULL)
                ...
                float clampResult28_g4063 = clamp(
                    (((tex2D(_UberNoiseTexture, (((IN.color.r * ((_SmokeVertexSeed) ? (5.0) : (0.0))) + temp_output_43_0_g4063) * temp_cast_12)).r - 1.0) * _SmokeNoiseFactor) + (((IN.color.a / 2.5) -
                        distance(temp_output_43_0_g4063, float2(0.5, 0.5))) * 2.5 * _SmokeSmoothness)), 0.0, 1.0);
                #ifdef _ENABLESMOKE_ON
                ...
                float clampResult70_g4067 = clamp(
                    (((tex2D(_UberNoiseTexture, (((shaderTime237 * _FlameSpeed) + temp_output_75_0_g4067) * _FlameNoiseScale)).r * pow(saferPower57_g4067, _FlameNoiseHeightFactor) * _FlameNoiseFactor)
                        + ((temp_output_47_0_g4067 - distance(temp_output_75_0_g4067, float2(0.5, 0.4))) / temp_output_47_0_g4067)) * _FlameSmooth), 0.0, 1.0);
                #ifdef _ENABLEFLAME_ON
                ...
                float lerpResult168_g4082 = lerp(temp_output_15_0_g4082.a,
                    min((max(
                        max(max(max(max(max(max(tex2D(_MainTex, (temp_output_131_0_g4082 + ((_OuterOutlineWidth * float2(0, -1)) * temp_output_25_0_g4082))).a,
                                            tex2D(_MainTex, (temp_output_131_0_g4082 + ((_OuterOutlineWidth * float2(0, 1)) * temp_output_25_0_g4082))).a),
                                        tex2D(_MainTex, (temp_output_131_0_g4082 + ((_OuterOutlineWidth * float2(-1, 0)) * temp_output_25_0_g4082))).a),
                                    tex2D(_MainTex, (temp_output_131_0_g4082 + ((_OuterOutlineWidth * float2(1, 0)) * temp_output_25_0_g4082))).a),
                                tex2D(_MainTex, (temp_output_131_0_g4082 + ((_OuterOutlineWidth * float2(0.705, 0.705)) * temp_output_25_0_g4082))).a),
                            tex2D(_MainTex, (temp_output_131_0_g4082 + ((_OuterOutlineWidth * float2(-0.705, 0.705)) * temp_output_25_0_g4082))).a),
                        tex2D(_MainTex, (temp_output_131_0_g4082 + ((_OuterOutlineWidth * float2(0.705, -0.705)) * temp_output_25_0_g4082))).a),
                        tex2D(_MainTex, (temp_output_131_0_g4082 + ((_OuterOutlineWidth * float2(-0.705, -0.705)) * temp_output_25_0_g4082))).a) * 3.0), 1.0), _OuterOutlineFade);
                ...
                float clampResult52_g4115 = clamp(
                    ((_CamouflageDensityA - tex2D(_UberNoiseTexture, (((_CamouflageAnimated)
                                                                                                                         ? ((((tex2D(_UberNoiseTexture,
                                                                          (((temp_output_40_0_g4111 * _CamouflageAnimationSpeed) + temp_output_99_0_g4115) *
                                                                              _CamouflageDistortionScale)).r - 0.25) * _CamouflageDistortionIntensity) +
                                                                                                                             temp_output_99_0_g4115))
                                                                                                                         : (temp_output_99_0_g4115)) * _CamouflageNoiseScaleA)).r) / max(
                        _CamouflageSmoothnessA, 0.005)), 0.0,
                    1.0);
                float4 lerpResult55_g4115 = lerp(_CamouflageBaseColor, (_CamouflageColorA * clampResult52_g4115), clampResult52_g4115);
                float clampResult65_g4115 = clamp(
                    ((_CamouflageDensityB - tex2D(
                        _UberNoiseTexture,
                        ((((_CamouflageAnimated)
                                                                                                                     ? ((((tex2D(_UberNoiseTexture,
            (((temp_output_40_0_g4111 * _CamouflageAnimationSpeed) + temp_output_99_0_g4115) * _CamouflageDistortionScale)).r - 0.25) *
                                                                                                                         _CamouflageDistortionIntensity) + temp_output_99_0_g4115))
                                                                                                                     : (temp_output_99_0_g4115)) + float2(12.3, 12.3)) * _CamouflageNoiseScaleB)).r) /
                    max(_CamouflageSmoothnessB, 0.005)), 0.0, 1.0);
                #ifdef _ENABLECAMOUFLAGE_ON
                ...
                float clampResult68_g4134 = clamp((_BurnInsideNoiseFactor - tex2D(
                    _UberNoiseTexture,
                    ((((tex2D(_UberNoiseTexture, (temp_output_72_0_g4134 * _BurnSwirlNoiseScale)).r -
                            0.5) * float2(1, 1) * _BurnSwirlFactor) + temp_output_72_0_g4134) *
