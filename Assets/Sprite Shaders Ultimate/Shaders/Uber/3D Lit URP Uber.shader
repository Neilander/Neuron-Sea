    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            VertexOutput VertexFunction(VertexInput v)
            {
                ...
                float clampResult14_g3885 = clamp(
                    (((_FullFade * (1.0 + temp_output_4_0_g3885)) - tex2Dlod(_UberNoiseTexture, float4((shaderPosition235 * _UberNoiseScale), 0, 0.0)).r) / temp_output_4_0_g3885), 0.0, 1.0);
                float2 temp_output_27_0_g3887 = shaderPosition235;
                float clampResult3_g3887 = clamp(
                    ((_FullFade - (distance(_UberPosition, temp_output_27_0_g3887) + (tex2Dlod(_UberNoiseTexture, float4((temp_output_27_0_g3887 * _UberNoiseScale), 0, 0.0)).r * _UberNoiseFactor))) /
            ...
            ) : SV_Target
            {
                ...
                float3 rotatedValue168_g3868 = RotateAroundAxis(float3(0, 0, 0), float3(_DirectionalDistortionDistortion, 0.0), float3(0, 0, 1),
                                                                       (((tex2D(_UberNoiseTexture, (temp_output_182_0_g3868 * _DirectionalDistortionDistortionScale)).r - 0.5) * 2.0 *
                ...
                float temp_output_4_0_g3885 = max(_UberWidth, 0.001);
                float clampResult14_g3885 = clamp((((_FullFade * (1.0 + temp_output_4_0_g3885)) - tex2D(_UberNoiseTexture, (shaderPosition235 * _UberNoiseScale)).r) / temp_output_4_0_g3885), 0.0,
                                                                                                             1.0);
                float2 temp_output_27_0_g3887 = shaderPosition235;
                float clampResult3_g3887 = clamp(
                    ((_FullFade - (distance(_UberPosition, temp_output_27_0_g3887) + (tex2D(_UberNoiseTexture, (temp_output_27_0_g3887 * _UberNoiseScale)).r * _UberNoiseFactor))) /
                        max(_UberWidth, 0.001)), 0.0, 1.0);
                #if defined(_UBERFADING_NONE)
                float staticSwitch139 = _FullFade;
                #elif defined(_UBERFADING_FULL)
                ...
                float clampResult28_g3907 = clamp(
                    (((tex2D(_UberNoiseTexture, (((IN.ase_color.r * ((_SmokeVertexSeed) ? (5.0) : (0.0))) + temp_output_43_0_g3907) * temp_cast_11)).r - 1.0) * _SmokeNoiseFactor) + (((IN.ase_color.a /
                        2.5) - distance(temp_output_43_0_g3907, float2(0.5, 0.5))) * 2.5 * _SmokeSmoothness)), 0.0, 1.0);
                #ifdef _ENABLESMOKE_ON
                ...
                float clampResult70_g3911 = clamp(
                    (((tex2D(_UberNoiseTexture, (((shaderTime237 * _FlameSpeed) + temp_output_75_0_g3911) * _FlameNoiseScale)).r * pow(saferPower57_g3911, _FlameNoiseHeightFactor) * _FlameNoiseFactor)
                        + ((temp_output_47_0_g3911 - distance(temp_output_75_0_g3911, float2(0.5, 0.4))) / temp_output_47_0_g3911)) * _FlameSmooth), 0.0, 1.0);
                #ifdef _ENABLEFLAME_ON
                ...
                float lerpResult168_g3926 = lerp(temp_output_15_0_g3926.a,
                                                                                                    min((max(
                                                                                                        max(
                                                                                                            max(
                                                                                                                max(
                                                                                                                    max(
                                                                                                                        max(
                                                                                                                            max(tex2D(_MainTex,
                                  (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0, -1)) *
                                      temp_output_25_0_g3926))).a,
                            tex2D(_MainTex,
                        (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0, 1)) *
                            temp_output_25_0_g3926))).a),
                                                                                                                            tex2D(_MainTex,
    (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(-1, 0)) *
        temp_output_25_0_g3926))).a),
                                                                                                                        tex2D(_MainTex,
                                                                                                                   (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(1, 0)) *
                                                                                                                       temp_output_25_0_g3926))).a),
                                                                                                                    tex2D(_MainTex,
                                                                      (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0.705, 0.705)) * temp_output_25_0_g3926))).a),
                                                                                                                tex2D(_MainTex,
                                                                                                                    (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(-0.705, 0.705)) *
                                                                                                                        temp_output_25_0_g3926))).a),
                                                                                                            tex2D(_MainTex,
        (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0.705, -0.705)) *
            temp_output_25_0_g3926))).a),
                                                                                                        tex2D(_MainTex,
                                                                   (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(-0.705, -0.705)) * temp_output_25_0_g3926))).a) * 3.0), 1.0),
                                                                                                    _OuterOutlineFade);
                ...
                float clampResult52_g3959 = clamp(
                    ((_CamouflageDensityA - tex2D(_UberNoiseTexture, (((_CamouflageAnimated)
                        ? ((((tex2D(_UberNoiseTexture, (((temp_output_40_0_g3955 * _CamouflageAnimationSpeed) + temp_output_99_0_g3959) * _CamouflageDistortionScale)).r - 0.25) *
                            _CamouflageDistortionIntensity) + temp_output_99_0_g3959))
                        : (temp_output_99_0_g3959)) * _CamouflageNoiseScaleA)).r) / max(_CamouflageSmoothnessA, 0.005)), 0.0, 1.0);
                float4 lerpResult55_g3959 = lerp(_CamouflageBaseColor, (_CamouflageColorA * clampResult52_g3959), clampResult52_g3959);
                float clampResult65_g3959 = clamp(
                    ((_CamouflageDensityB - tex2D(
                        _UberNoiseTexture,
                        ((((_CamouflageAnimated)
                                                  ? ((((tex2D(_UberNoiseTexture, (((temp_output_40_0_g3955 * _CamouflageAnimationSpeed) + temp_output_99_0_g3959) * _CamouflageDistortionScale)).r -
                                                      0.25) * _CamouflageDistortionIntensity) + temp_output_99_0_g3959))
                                                  : (temp_output_99_0_g3959)) + float2(12.3, 12.3)) * _CamouflageNoiseScaleB)).r) / max(_CamouflageSmoothnessB, 0.005)), 0.0, 1.0);
                #ifdef _ENABLECAMOUFLAGE_ON
                ...
                float clampResult68_g3978 = clamp((_BurnInsideNoiseFactor - tex2D(
                                                       _UberNoiseTexture,
                                                       ((((tex2D(_UberNoiseTexture, (temp_output_72_0_g3978 * _BurnSwirlNoiseScale)).r - 0.5) * float2(1, 1) * _BurnSwirlFactor) +
                                                           temp_output_72_0_g3978) * _BurnInsideNoiseScale)).r),
                                                   0.0, 1.0);
                #ifdef _ENABLEBURN_ON
                ...
                float lerpResult168_g3926 = lerp(temp_output_15_0_g3926.a,
                   min((max(
                                                                        max(max(max(max(max(max(tex2D(_MainTex,
                                                                                                   (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0, -1)) * temp_output_25_0_g3926))).a,
                                                                                             tex2D(_MainTex,
                (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0, 1)) * temp_output_25_0_g3926))).a),
                                                                                         tex2D(_MainTex,
                                                                                             (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(-1, 0)) * temp_output_25_0_g3926))).a),
                                                                                     tex2D(_MainTex,
                                                                 (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(1, 0)) * temp_output_25_0_g3926))).a),
                                                                                 tex2D(_MainTex,
                                                                                     (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0.705, 0.705)) *
                                                                             ...
                                                                             tex2D(_MainTex,
(temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(-0.705, 0.705)) * temp_output_25_0_g3926))).a),
                                                                         tex2D(_MainTex, (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0.705, -0.705)) * temp_output_25_0_g3926)))
                                                                         .a), tex2D(_MainTex,
    (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(-0.705, -0.705)) * temp_output_25_0_g3926))).a) * 3.0), 1.0), _OuterOutlineFade);
                #ifdef _ENABLEOUTEROUTLINE_ON
				float4 appendResult174_g3926 = (float4(lerpResult170_g3926 , lerpResult168_g3926));
				float4 staticSwitch13_g3913 = appendResult174_g3926;
                #else
                ...
                float clampResult52_g3959 = clamp(
                   ...
                   (((temp_output_40_0_g3955 * _CamouflageAnimationSpeed) + temp_output_99_0_g3959) * _CamouflageDistortionScale)).r - 0.25) * _CamouflageDistortionIntensity) +
            ...
            : (temp_output_99_0_g3959)) + float2(12.3, 12.3)) * _CamouflageNoiseScaleB)).r) / max(_CamouflageSmoothnessB, 0.005)), 0.0, 1.0);
                ...
                float clampResult68_g3978 = clamp((_BurnInsideNoiseFactor - tex2D(
                    _UberNoiseTexture,
                    ((((tex2D(_UberNoiseTexture, (temp_output_72_0_g3978 * _BurnSwirlNoiseScale)).r - 0.5) * float2(1, 1) * _BurnSwirlFactor) +
                        temp_output_72_0_g3978) * _BurnInsideNoiseScale)).r), 0.0, 1.0);
                #ifdef _ENABLEBURN_ON
				float temp_output_15_0_g3978 = ( ( ( _BurnRadius - distance( temp_output_72_0_g3978 , _BurnPosition ) ) + ( tex2D( _UberNoiseTexture, ( temp_output_72_0_g3978 * _BurnEdgeNoiseScale ) ).r * _BurnEdgeNoiseFactor ) ) / max( _BurnWidth , 0.01 ) );
				float clampResult18_g3978 = clamp( temp_output_15_0_g3978 , 0.0 , 1.0 );
				float3 lerpResult29_g3978 = lerp( temp_output_28_0_g3978 , ( pow( saferPower21_g3978 , max( _BurnInsideContrast , 0.001 ) ) * ( ( (_BurnInsideNoiseColor).rgb * clampResult68_g3978 ) + (_BurnInsideColor).rgb ) ) , clampResult18_g3978);
        ...
        Pass
        {
            ...
            ) : SV_TARGET
            {
                ...
                float lerpResult168_g3926 = lerp(temp_output_15_0_g3926.a,
                                                                                                    min((max(
                                                      max(max(max(max(max(max(tex2D(_MainTex, (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0, -1)) * temp_output_25_0_g3926))).a,
                                                                                                                                      tex2D(_MainTex,
                                                                  (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0, 1)) * temp_output_25_0_g3926))).a),
                                                                                                                                  tex2D(_MainTex,
                                                                                                                                      (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(-1, 0)) *
                  ...
                  (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0.705, 0.705)) *
                      temp_output_25_0_g3926))).a),
                           ...
                           (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0.705, -0.705)) *
                               temp_output_25_0_g3926))).a),
                                                      tex2D(_MainTex, (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(-0.705, -0.705)) * temp_output_25_0_g3926))).a) * 3.0), 1.0),
                                                                                                    _OuterOutlineFade);
                #ifdef _ENABLEOUTEROUTLINE_ON
				float4 appendResult174_g3926 = (float4(lerpResult170_g3926 , lerpResult168_g3926));
				float4 staticSwitch13_g3913 = appendResult174_g3926;
                ...
                float clampResult68_g3978 = clamp((_BurnInsideNoiseFactor - tex2D(
                                    _UberNoiseTexture,
                                    ((((tex2D(_UberNoiseTexture, (temp_output_72_0_g3978 * _BurnSwirlNoiseScale)).r - 0.5) * float2(1, 1) * _BurnSwirlFactor) + temp_output_72_0_g3978) *
        ...
        Pass
        {
            ...
            half4 frag(VertexOutput IN) : SV_TARGET
            {
                ...
                float lerpResult168_g3926 = lerp(temp_output_15_0_g3926.a,
                                                  min((max(
                               max(max(max(max(max(max(tex2D(_MainTex, (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0, -1)) * temp_output_25_0_g3926))).a,
                                                                                        tex2D(_MainTex, (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0, 1)) * temp_output_25_0_g3926))).a),
                                                                                    tex2D(_MainTex, (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(-1, 0)) * temp_output_25_0_g3926))).a),
                                                                                tex2D(_MainTex, (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(1, 0)) * temp_output_25_0_g3926))).a),
                                                                            tex2D(_MainTex, (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0.705, 0.705)) * temp_output_25_0_g3926))).a),
                                                                        tex2D(_MainTex, (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(-0.705, 0.705)) * temp_output_25_0_g3926))).a),
                                                                    tex2D(_MainTex, (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0.705, -0.705)) * temp_output_25_0_g3926))).a),
                               tex2D(_MainTex, (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(-0.705, -0.705)) * temp_output_25_0_g3926))).a) * 3.0), 1.0), _OuterOutlineFade);
                #ifdef _ENABLEOUTEROUTLINE_ON
				float4 appendResult174_g3926 = (float4(lerpResult170_g3926 , lerpResult168_g3926));
				float4 staticSwitch13_g3913 = appendResult174_g3926;
                #else
        ...
        Pass
        {
            ...
            half4 frag(VertexOutput IN) : SV_TARGET
            {
                                                                                ...
                                                                                max(
                                                                                    max(
                                                                                        max(
                                                                                            max(
                                                                                                max(tex2D(_MainTex,
                                  (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0, -1)) * temp_output_25_0_g3926)))
                            .a, tex2D(_MainTex, (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0, 1)) * temp_output_25_0_g3926))).a),
                                                                                                tex2D(_MainTex,
                                           (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(-1, 0)) * temp_output_25_0_g3926))).a),
                                                                                            tex2D(_MainTex, (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(1, 0)) * temp_output_25_0_g3926))).
                                                                                            a),
                                                                                        tex2D(_MainTex,
                                                                                            (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(0.705, 0.705)) * temp_output_25_0_g3926))).a),
                                                                                    tex2D(_MainTex, (temp_output_131_0_g3926 + ((_OuterOutlineWidth * float2(-0.705, 0.705)) * temp_output_25_0_g3926)))
                ...
                float clampResult52_g3959 = clamp(
                    ((_CamouflageDensityA - tex2D(_UberNoiseTexture, (((_CamouflageAnimated)
                                                                                                   ? ((((tex2D(_UberNoiseTexture,
                                                                                                           (((temp_output_40_0_g3955 * _CamouflageAnimationSpeed) + temp_output_99_0_g3959) *
                                                                                                               _CamouflageDistortionScale)).r - 0.25) *
                                                                                                       _CamouflageDistortionIntensity) + temp_output_99_0_g3959))
                                                                                                   : (temp_output_99_0_g3959)) * _CamouflageNoiseScaleA)).r) / max(_CamouflageSmoothnessA, 0.005)), 0.0,
                    1.0);
                float4 lerpResult55_g3959 = lerp(_CamouflageBaseColor, (_CamouflageColorA * clampResult52_g3959), clampResult52_g3959);
                float clampResult65_g3959 = clamp(
                    ((_CamouflageDensityB - tex2D(
                ...
                float clampResult68_g3978 = clamp((_BurnInsideNoiseFactor - tex2D(
                       _UberNoiseTexture,
                       ((((tex2D(_UberNoiseTexture, (temp_output_72_0_g3978 * _BurnSwirlNoiseScale)).r - 0.5) *
                           float2(1, 1) * _BurnSwirlFactor) + temp_output_72_0_g3978) * _BurnInsideNoiseScale)).r), 0.0,
                   1.0);
                #ifdef _ENABLEBURN_ON
				float temp_output_15_0_g3978 = ( ( ( _BurnRadius - distance( temp_output_72_0_g3978 , _BurnPosition ) ) + ( tex2D( _UberNoiseTexture, ( temp_output_72_0_g3978 * _BurnEdgeNoiseScale ) ).r * _BurnEdgeNoiseFactor ) ) / max( _BurnWidth , 0.01 ) );
				float clampResult18_g3978 = clamp( temp_output_15_0_g3978 , 0.0 , 1.0 );
