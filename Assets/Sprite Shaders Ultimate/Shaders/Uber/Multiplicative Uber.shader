    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata_t IN)
            {
                ...
                float clampResult14_g3889 = clamp(
                    (((_FullFade * (1.0 + temp_output_4_0_g3889)) - tex2Dlod(_UberNoiseTexture, float4((shaderPosition235 * _UberNoiseScale), 0, 0.0)).r) / temp_output_4_0_g3889), 0.0, 1.0);
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float temp_output_4_0_g3889 = max(_UberWidth, 0.001);
                float clampResult14_g3889 = clamp((((_FullFade * (1.0 + temp_output_4_0_g3889)) - tex2D(_UberNoiseTexture, (shaderPosition235 * _UberNoiseScale)).r) / temp_output_4_0_g3889), 0.0,
                                         1.0);
                float2 temp_output_27_0_g3887 = shaderPosition235;
                float clampResult3_g3887 = clamp(
                ...
                float clampResult28_g3908 = clamp(
                    (((tex2D(_UberNoiseTexture, (((IN.color.r * ((_SmokeVertexSeed) ? (5.0) : (0.0))) + temp_output_43_0_g3908) * temp_cast_11)).r - 1.0) * _SmokeNoiseFactor) + (((IN.color.a / 2.5) -
                        distance(temp_output_43_0_g3908, float2(0.5, 0.5))) * 2.5 * _SmokeSmoothness)), 0.0, 1.0);
                #ifdef _ENABLESMOKE_ON
                ...
                float clampResult70_g3912 = clamp(
                    (((tex2D(_UberNoiseTexture, (((shaderTime237 * _FlameSpeed) + temp_output_75_0_g3912) * _FlameNoiseScale)).r * pow(saferPower57_g3912, _FlameNoiseHeightFactor) * _FlameNoiseFactor)
                        + ((temp_output_47_0_g3912 - distance(temp_output_75_0_g3912, float2(0.5, 0.4))) / temp_output_47_0_g3912)) * _FlameSmooth), 0.0, 1.0);
                #ifdef _ENABLEFLAME_ON
                ...
                float lerpResult168_g3927 = lerp(temp_output_15_0_g3927.a,
                    min((max(
                        max(max(max(max(max(max(tex2D(_MainTex, (temp_output_131_0_g3927 + ((_OuterOutlineWidth * float2(0, -1)) * temp_output_25_0_g3927))).a,
                                                             tex2D(_MainTex, (temp_output_131_0_g3927 + ((_OuterOutlineWidth * float2(0, 1)) * temp_output_25_0_g3927))).a),
                                                         tex2D(_MainTex, (temp_output_131_0_g3927 + ((_OuterOutlineWidth * float2(-1, 0)) * temp_output_25_0_g3927))).a),
                                                     tex2D(_MainTex, (temp_output_131_0_g3927 + ((_OuterOutlineWidth * float2(1, 0)) * temp_output_25_0_g3927))).a),
                                                 tex2D(_MainTex, (temp_output_131_0_g3927 + ((_OuterOutlineWidth * float2(0.705, 0.705)) * temp_output_25_0_g3927))).a),
                                             tex2D(_MainTex, (temp_output_131_0_g3927 + ((_OuterOutlineWidth * float2(-0.705, 0.705)) * temp_output_25_0_g3927))).a),
                                         tex2D(_MainTex, (temp_output_131_0_g3927 + ((_OuterOutlineWidth * float2(0.705, -0.705)) * temp_output_25_0_g3927))).a),
                        tex2D(_MainTex, (temp_output_131_0_g3927 + ((_OuterOutlineWidth * float2(-0.705, -0.705)) * temp_output_25_0_g3927))).a) * 3.0), 1.0), _OuterOutlineFade);
                ...
                float clampResult52_g3960 = clamp(
                    ((_CamouflageDensityA - tex2D(_UberNoiseTexture, (((_CamouflageAnimated)
                                          ? ((((tex2D(_UberNoiseTexture, (((temp_output_40_0_g3956 * _CamouflageAnimationSpeed) + temp_output_99_0_g3960) * _CamouflageDistortionScale)).r - 0.25) *
                                              _CamouflageDistortionIntensity) + temp_output_99_0_g3960))
                                          : (temp_output_99_0_g3960)) * _CamouflageNoiseScaleA)).r) / max(_CamouflageSmoothnessA, 0.005)), 0.0, 1.0);
                float4 lerpResult55_g3960 = lerp(_CamouflageBaseColor, (_CamouflageColorA * clampResult52_g3960), clampResult52_g3960);
                float clampResult65_g3960 = clamp(
                    ((_CamouflageDensityB - tex2D(
                        _UberNoiseTexture,
                        ((((_CamouflageAnimated)
                         ? ((((tex2D(_UberNoiseTexture, (((temp_output_40_0_g3956 * _CamouflageAnimationSpeed) + temp_output_99_0_g3960) * _CamouflageDistortionScale)).r -
                             0.25) * _CamouflageDistortionIntensity) + temp_output_99_0_g3960))
                         : (temp_output_99_0_g3960)) + float2(12.3, 12.3)) * _CamouflageNoiseScaleB)).r) / max(_CamouflageSmoothnessB, 0.005)), 0.0, 1.0);
                #ifdef _ENABLECAMOUFLAGE_ON
                ...
                float clampResult68_g3979 = clamp((_BurnInsideNoiseFactor - tex2D(
                        _UberNoiseTexture,
                        ((((tex2D(_UberNoiseTexture, (temp_output_72_0_g3979 * _BurnSwirlNoiseScale)).r - 0.5) * float2(1, 1) * _BurnSwirlFactor) + temp_output_72_0_g3979) * _BurnInsideNoiseScale)).
                    r), 0.0, 1.0);
                #ifdef _ENABLEBURN_ON
