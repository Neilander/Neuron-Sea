    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float clampResult28_g50 = clamp(
                    (((tex2D(_SmokeNoiseTexture, (((IN.color.r * ((_SmokeVertexSeed) ? (5.0) : (0.0))) + temp_output_43_0_g50) * temp_cast_0)).r - 1.0) * _SmokeNoiseFactor) + (((IN.color.a / 2.5) -
                        distance(temp_output_43_0_g50, float2(0.5, 0.5))) * 2.5 * _SmokeSmoothness)), 0.0, 1.0);
