    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float3 lerpResult7_g10 = lerp((temp_output_1_0_g10).rgb,
                                              (pow((((break2_g11.x + break2_g11.y + break2_g11.z) / 3.0) + (0.1 * max((1.0 - temp_output_9_0_g12), 0.0))), temp_output_9_0_g12) * (_StrongTintTint).
                                                  rgb), _StrongTintFade);
