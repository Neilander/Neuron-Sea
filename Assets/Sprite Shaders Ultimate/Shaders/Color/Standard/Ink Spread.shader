    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float clampResult53_g193 = clamp(
                    (((_InkSpreadDistance - distance(_InkSpreadPosition, temp_output_65_0_g193)) + (tex2D(_InkSpreadNoiseTexture, (temp_output_65_0_g193 * _InkSpreadNoiseScale)).r *
                        _InkSpreadNoiseFactor)) / max(_InkSpreadWidth, 0.001)), 0.0, 1.0);
