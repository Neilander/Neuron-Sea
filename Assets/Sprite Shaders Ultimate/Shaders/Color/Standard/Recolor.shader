    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float3 lerpResult26_g46 = lerp((temp_output_1_0_g46).rgb, (appendResult56_g46 * pow(((break2_g47.x + break2_g47.y + break2_g47.z) / 3.0), max((break55_g46.a * 2.0), 0.01))),
                                               (hsvTorgb33_g46.z * _RecolorFade));
