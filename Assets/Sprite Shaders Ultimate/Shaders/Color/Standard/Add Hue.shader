    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float4 appendResult6_g25 = (float4(
                    ((hsvTorgb19_g25 * pow(saferPower27_g25, max(_AddHueContrast, 0.001)) * (_AddHueFade * (tex2DNode3_g27.r * tex2DNode3_g27.a))) + (temp_output_1_0_g25).rgb),
                    temp_output_1_0_g25.a));
