    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float clampResult35_g70 = clamp(
                    (1.0 - (min(min(distance(hsvTorgb7_g70.x, hsvTorgb5_g70.x), distance(hsvTorgb7_g70.x, (hsvTorgb5_g70.x + 1.0))), distance(hsvTorgb7_g70.x, (hsvTorgb5_g70.x + -1.0))) / max(
                        (_ColorReplaceHueTolerance * 0.15), 0.001))), 0.0, 1.0);
                ...
                float3 lerpResult23_g70 = lerp(temp_output_2_0_g70, (pow(saferPower7_g72, temp_output_9_0_g72) * (_ColorReplaceColor).rgb),
                                               (pow(saferPower48_g70, max(_ColorReplaceBias, 0.001)) * _ColorReplaceFade));
