    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float3 lerpResult176_g502 = lerp((temp_output_15_0_g502).rgb, (_InnerOutlineColor).rgb, (_InnerOutlineFade * (1.0 - min(
                    min(min(min(min(min(min(tex2D(_MainTex, (temp_output_131_0_g502 + ((_InnerOutlineWidth * float2(0, -1)) * temp_output_25_0_g502))).a,
                                            tex2D(_MainTex, (temp_output_131_0_g502 + ((_InnerOutlineWidth * float2(0, 1)) * temp_output_25_0_g502))).a),
                                        tex2D(_MainTex, (temp_output_131_0_g502 + ((_InnerOutlineWidth * float2(-1, 0)) * temp_output_25_0_g502))).a),
                                    tex2D(_MainTex, (temp_output_131_0_g502 + ((_InnerOutlineWidth * float2(1, 0)) * temp_output_25_0_g502))).a),
                                tex2D(_MainTex, (temp_output_131_0_g502 + ((_InnerOutlineWidth * float2(0.705, 0.705)) * temp_output_25_0_g502))).a),
                            tex2D(_MainTex, (temp_output_131_0_g502 + ((_InnerOutlineWidth * float2(-0.705, 0.705)) * temp_output_25_0_g502))).a),
                        tex2D(_MainTex, (temp_output_131_0_g502 + ((_InnerOutlineWidth * float2(0.705, -0.705)) * temp_output_25_0_g502))).a),
                    tex2D(_MainTex, (temp_output_131_0_g502 + ((_InnerOutlineWidth * float2(-0.705, -0.705)) * temp_output_25_0_g502))).a))));
