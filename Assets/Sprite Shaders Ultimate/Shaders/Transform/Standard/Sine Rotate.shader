    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float3 rotatedValue36_g22 = RotateAroundAxis(float3(_SineRotatePivot, 0.0), float3(texCoord35, 0.0), float3(0, 0, 1),
                                                             (sin((staticSwitch1_g31 * _SineRotateFrequency)) * ((_SineRotateAngle / 360.0) * UNITY_PI) * _SineRotateFade));
