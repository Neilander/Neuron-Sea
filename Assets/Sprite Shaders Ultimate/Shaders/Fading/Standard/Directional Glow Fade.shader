    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float temp_output_168_0_g272 = max(
                    ((break130_g272.x + break130_g272.y + _DirectionalGlowFadeFade + (tex2D(_DirectionalGlowFadeNoiseTexture, (temp_output_171_0_g272 * _DirectionalGlowFadeNoiseScale)).r *
                        _DirectionalGlowFadeNoiseFactor)) / max(_DirectionalGlowFadeWidth, 0.001)), 0.0);
                ...
                float4 appendResult3_g272 = (float4(
                    (((_DirectionalGlowFadeEdgeColor).rgb * (temp_output_161_0_g272 - step(1.0, ((_DirectionalGlowFadeInvert) ? ((1.0 - temp_output_168_0_g272)) : (temp_output_168_0_g272))))) + (
                        temp_output_1_0_g272).rgb), (temp_output_1_0_g272.a * clampResult154_g272)));
