    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float clampResult37_g74 = clamp(
                    (((IN.color.a * 2.0) - 1.0) + (tex2DNode3_g74.r + (tex2D(_CustomFadeNoiseTexture, (temp_output_57_0_g74 * _CustomFadeNoiseScale)).r * _CustomFadeNoiseFactor))), 0.0, 1.0);
                float4 appendResult13_g74 = (float4((float4((IN.color).rgb, 0.0) * temp_output_1_0_g74).rgb,
                                                    (temp_output_1_0_g74.a * pow(clampResult37_g74, (_CustomFadeSmoothness / max(tex2DNode3_g74.r, 0.05))) * _CustomFadeAlpha)));
