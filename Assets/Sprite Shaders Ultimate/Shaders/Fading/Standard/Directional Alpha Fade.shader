    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float clampResult154_g232 = clamp(
                    ((break130_g232.x + break130_g232.y + _DirectionalAlphaFadeFade + (tex2D(_DirectionalAlphaFadeNoiseTexture, (temp_output_161_0_g232 * _DirectionalAlphaFadeNoiseScale)).r *
                        _DirectionalAlphaFadeNoiseFactor)) / max(_DirectionalAlphaFadeWidth, 0.001)), 0.0, 1.0);
