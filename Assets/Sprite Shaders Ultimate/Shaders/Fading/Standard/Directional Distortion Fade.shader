    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float3 rotatedValue168_g342 = RotateAroundAxis(float3(0, 0, 0), float3(_DirectionalDistortionDistortion, 0.0), float3(0, 0, 1),
                    (((tex2D(_DirectionalDistortionNoiseTexture, (temp_output_182_0_g342 * _DirectionalDistortionDistortionScale)).r - 0.5) * 2.0 * _DirectionalDistortionRandomDirection) * UNITY_PI));
                ...
                float clampResult154_g342 = clamp(
                    ((break130_g342.x + break130_g342.y + _DirectionalDistortionFade + (tex2D(_DirectionalDistortionNoiseTexture, (temp_output_182_0_g342 * _DirectionalDistortionNoiseScale)).r *
                ...
                float4 appendResult5_g340 = (float4(break4_g340.r, break4_g340.g, break4_g340.b,
                                                    (break4_g340.a * ((_DirectionalDistortionInvert) ? ((1.0 - clampResult154_g342)) : (clampResult154_g342)))));
