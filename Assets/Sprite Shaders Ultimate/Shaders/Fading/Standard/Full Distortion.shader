    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float2 appendResult189_g366 = (float2((tex2D(_FullDistortionNoiseTexture, (temp_output_195_0_g366 * _FullDistortionNoiseScale)).r - 0.5),
                                                      (tex2D(_FullDistortionNoiseTexture, ((temp_output_195_0_g366 + float2(0.321, 0.321)) * _FullDistortionNoiseScale)).r - 0.5)));
