        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float clampResult17_g163 = clamp(
                    (((_FullAlphaDissolveFade * (1.0 + temp_output_53_0_g163)) - tex2D(_FullAlphaDissolveNoiseTexture, (staticSwitch1_g165 * _FullAlphaDissolveNoiseScale)).r) / temp_output_53_0_g163),
                    0.0, 1.0);
