    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float clampResult17_g163 = clamp(
                    ((_SourceAlphaDissolveFade - (distance(_SourceAlphaDissolvePosition, temp_output_76_0_g163) + (tex2D(
                        _SourceAlphaDissolveNoiseTexture, (temp_output_76_0_g163 * _SourceAlphaDissolveNoiseScale)).r * _SourceAlphaDissolveNoiseFactor))) / max(_SourceAlphaDissolveWidth, 0.001)),
                    0.0, 1.0);
