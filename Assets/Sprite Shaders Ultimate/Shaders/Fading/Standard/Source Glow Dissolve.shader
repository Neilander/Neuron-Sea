    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float temp_output_65_0_g163 = (distance(_SourceGlowDissolvePosition, temp_output_90_0_g163) + (tex2D(_SourceGlowDissolveNoiseTexture,
                                                                                                                     (temp_output_90_0_g163 * _SourceGlowDissolveNoiseScale)).r *
                    _SourceGlowDissolveNoiseFactor));
                ...
                float4 appendResult3_g163 = (float4(((max((temp_output_75_0_g163 - temp_output_76_0_g163), 0.0) * (_SourceGlowDissolveEdgeColor).rgb) + (temp_output_1_0_g163).rgb),
                                                    (temp_output_1_0_g163.a * ((_SourceGlowDissolveInvert) ? ((1.0 - temp_output_76_0_g163)) : (temp_output_75_0_g163)))));
