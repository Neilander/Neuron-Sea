...
public class DoubleJumpModule : GroundedControllerAbilityModule
{
    ...
    public override bool IsApplicable(){
        ...
        if (m_ControlledCollider.IsGrounded() || m_CharacterController.DidJustJump() ||
            (Time.fixedTime - m_CharacterController.GetLastGroundedTime() <= m_CharacterController.GetGroundedToleranceTime())) {
            return false;
        }
