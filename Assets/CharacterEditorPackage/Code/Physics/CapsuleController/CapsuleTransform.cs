...
public class CapsuleTransform
{
    ...
    public bool CanBeResized(float a_Length, CapsuleResizeMethod a_Method){
        ...
        switch (a_Method) {
            case CapsuleResizeMethod.FromCenter:
                return (!Physics.CheckCapsule(newPosition - m_CapsuleCollider.GetUpDirection() * a_Length * 0.5f, newPosition + m_CapsuleCollider.GetUpDirection() * a_Length * 0.5f,
                    m_CapsuleCollider.GetRadius(), m_CapsuleCollider.GetLayerMask()));
            case CapsuleResizeMethod.FromBottom:
                return (!Physics.CheckCapsule(m_CapsuleCollider.GetDownCenter(), m_CapsuleCollider.GetDownCenter() + m_CapsuleCollider.GetUpDirection() * a_Length,
                    m_CapsuleCollider.GetRadius() - m_CapsuleCollider.GetResizeCastMargin(), m_CapsuleCollider.GetLayerMask()));
            case CapsuleResizeMethod.FromTop:
                return (!Physics.CheckCapsule(m_CapsuleCollider.GetUpCenter(), m_CapsuleCollider.GetUpCenter() - m_CapsuleCollider.GetUpDirection() * a_Length,
                    m_CapsuleCollider.GetRadius() - m_CapsuleCollider.GetResizeCastMargin(), m_CapsuleCollider.GetLayerMask()));
        }
        return true;
    }
