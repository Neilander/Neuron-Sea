...
public class CCGroundedInfo : CGroundedInfo
{
    ...
    public override bool IsDangling(){
        bool hit = Physics.Raycast(m_CapsuleCollider.GetCapsuleTransform().GetDownCenter(), Vector3.down, m_CapsuleCollider.GetRadius() + m_CapsuleCollider.GetGroundedMargin(),
