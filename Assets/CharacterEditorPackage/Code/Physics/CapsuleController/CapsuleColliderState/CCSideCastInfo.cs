...
public class CCSideCastInfo : CSideCastInfo
{
    ...
    public void UpdateWithCollisions(List<RaycastHit> leftHitResults, List<RaycastHit> rightHitResults){
        ...
        bool correctCast1Hit = Physics.Raycast(m_MostValidHit.point + m_MostValidHit.normal * 0.02f + dirAlongNormal * 0.01f, -m_MostValidHit.normal, out correctingCast1, 0.03f,
            m_CapsuleCollider.GetLayerMask());
        bool correctCast2Hit = Physics.Raycast(m_MostValidHit.point + m_MostValidHit.normal * 0.02f - dirAlongNormal * 0.01f, -m_MostValidHit.normal, out correctingCast2, 0.03f,
            m_CapsuleCollider.GetLayerMask());
